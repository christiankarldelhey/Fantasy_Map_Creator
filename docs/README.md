...
- **[GIS Lesson 1: Fundamentos Teóricos para Desarrolladores](./gis-lesson-1.md)**
  - Conceptos fundamentales de GIS
  - ArcGIS: plataforma, componentes y certificaciones
  - FME Flow/Form: integración de datos espaciales
  - SAP PM: integración GIS en empresas
  - Fundamentos de geografía para desarrolladores
  - Glosario completo de términos GIS
  - Todos los ejemplos basados en el proyecto Middle Earth
...
- **[02 - FASE 1: Backend API GraphQL + Frontend Vue 3](./02-fase-1-backend-frontend.md)**
  - Setup del Backend (Node.js + Express)
  - PostGraphile - API GraphQL automática desde PostGIS
  - Endpoints REST complementarios
  - Setup del Frontend (Vue 3 + Vite)
  - ArcGIS Maps SDK - Mapa base interactivo
  - Capas de PostGIS con GraphQL
  - Popups y visualización
  - Búsqueda y filtros
  - Edición de features
  - Sistema de clima simulado (mock)

### Fases Futuras (Pendientes)

- **FASE 2:** Sistema de Clima Real + Caminos y Rutas
- **FASE 3:** Autenticación y Edición Colaborativa
- **FASE 4:** Sistema de Routing con pgRouting
- **FASE 5:** Análisis Espacial Avanzado
...
- FASE 0: Setup PostgreSQL + PostGIS
  ...
  - 206 ubicaciones cargadas
  - 39 regiones cargadas
  - Queries espaciales validadas
  - QGIS conectado para visualización

### 🔄 En Progreso
- FASE 1: Backend API GraphQL + Frontend Vue 3
  - Documento pedagógico creado
