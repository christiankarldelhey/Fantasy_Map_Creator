-- Migration: Create region_biome_descriptions table
-- Date: 2026-07-02
-- Description: Store per-region, per-category narrative phrases for terrain,
--              biomes, altitude layers and road types used by the day prompt.
