...
// ----------------------------------------------------------------------------
// Voice and style only — never day data. It is identical for every character;
// per-character perspective goes in the NARRATOR'S LENS section of the user
// message. Exposed over HTTP by GET /api/trips/meta/system-prompt so the
// frontend System tab reads it from code instead of duplicating it.
// ============================================================================
